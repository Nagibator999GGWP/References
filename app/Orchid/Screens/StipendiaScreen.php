...
class StipendiaScreen extends Screen
{
    /**
    ...
    public function layout(): iterable
    {
        return [
            Layout::rows([
                ...
                DateTimer::make('styde.дата рождения')
                ->title('Период начисления стипендии')
                ->format('Y-m-d')
                ->range()
                ->placeholder('Выберите дату')
                ->allowInput(),
                ...
                Input::make('styde.количество справок')
                    ...
                    ->placeholder('Введите количество справок')
                    ->required(),

                Input::make('styde.дата')
                    ->title('Дата заказа справки')
                    ->placeholder('Введите дату заказа справки')
                    ->type('number'),
                Button::make('Заказать')->method('CreateRequest')->class('btn btn-outline-secondary ')
            ])
        ];
    }
